...
import br.com.cleomilsonsales.cm.modelo.Campo;
import br.com.cleomilsonsales.cm.modelo.CampoEvento;
import br.com.cleomilsonsales.cm.modelo.CampoObservador;
...
public class BotaoCampo extends JButton 
	...
	public void eventoOcorreu(Campo ccampo, CampoEvento evento) {
		...
		//forçando o componente ser reiniciado
